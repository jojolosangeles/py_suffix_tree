...
from suffix_tree.suffix_tree import TreeBuilder, NodeStore
...
def test_sequence(data, testcount, rlen):
    ...
    nodeStore = NodeStore()
    builder = TreeBuilder(data_generator, DataStore(), NodeFactory(SuffixLinker()), nodeStore)
    builder.process_all_values()
    depth_visit(nodeStore, builder.root, builder.last_offset)
...
test_str = "fbfceeeaffbfe" #None #"ddaaeeadfececeb"
#test_str = "fbfceeea"
#test_str = "fbfceee"
#test_str = "feee"
#test_str = "fbfceeea"
